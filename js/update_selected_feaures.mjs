...
// ###2
export const update_selected_features = (new_id) => {
    ...
    window.dalatmap.setFeatureState(
        { source: SOURCES_NAMES.CITY_TILES, sourceLayer: TITLES_MAIN_TILE_LAYER, id: curr_id },
        { selected: false }
    )
    window.dalatmap.setFeatureState(
        { source: SOURCES_NAMES.CITY_TILES, sourceLayer: TITLES_MAIN_TILE_LAYER, id: new_id },
        { selected: true }
    )
}
